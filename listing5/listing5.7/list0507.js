...
document.write("Массив<code>A</code> псоле выплднение команды<code>A.reverse()</code>:<br>")

show(A)

A.shift()

document.write("Массив <code>A</code> псоле выполнения команды <code>A.shift()</code>:<br>")

show(A)

A.pop()

document.write("Массив<code>A</code> после  выполения команды<code>A.pop()</code>:<br>")
show(A)
...
document.write("Значение выражения <code>A</code> после выполнения команды <code>A.slice(2,6)</code>:<br>")

show(A)

A.splice(3,2,-1,-2,-3)
document.write("Массив <code>A</code> после выполнение команды <code>A.splice(3.2,-1,-2,-3)</code>:<br>")
